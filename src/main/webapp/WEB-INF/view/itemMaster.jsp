					    ...
					    <div class="card bg-light shadow cardform">
					        <div class="card-body">
					           <table style="width:50%">
					             <form>
					              <tr>
					                <td style="width: 20%"><label for="staticEmail" class="col-form-label">Main</label></td>
					              ...
					              <tr>
					                <td style="width: 20%"><label for="staticEmail" class="col-form-label">Old Item Code</label></td>
					                <td style="width: 80%" colspan="2"><input type="text" class="form-control form-control-sm" id="exampleInputPassword1"></td>
					              </tr>
					              <tr>
					                <td style="width: 20%"><label for="staticEmail" class="col-form-label">Item Name</label></td>
					                <td style="width: 80%" colspan="2"><input type="text" class="form-control form-control-sm" id="exampleInputPassword1"></td>
					              </tr>
					              <tr>
					                <td style="width: 20%"><label for="staticEmail" class="col-form-label">Uom Code</label></td>
					              ...
					              <tr>
					                <td style="width: 20%"><label for="staticEmail" class="col-form-label">Pack Size</label></td>
					                <td style="width: 20%"><input type="text" class="form-control form-control-sm" id="exampleInputPassword1"></td>
					                <td style="width: 60%"><input type="text" class="form-control form-control-sm" id="exampleInputPassword1"></td>
					              </tr>
					              <tr>

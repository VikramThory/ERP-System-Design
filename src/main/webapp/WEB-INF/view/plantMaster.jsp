					           ...
					           <table style="width:50%">
					             <form>
					              <tr>
					                ...
					                <td style="width: 30%" class="inputsize"><select class="form-control form-control-sm">
					                  <option>Breawing</option>
					                </select></td>
					              </tr>
					              <tr>
					              ...
					              <tr>
					                <td style="width: 20%"><label for="staticEmail" class="col-form-label">Unit</label></td>
					                <td class="inputsize">
